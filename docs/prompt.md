...
**8B 结论**:全部 12 配置均 <1×(0.72-0.98×)——8B prefill 太便宜,任何 chunk/L1 组合都无法抵消传输开销;最优 chunk=128/L1=8GB(0.98×),最差 chunk=1024/L1=4GB(0.72×,大 chunk 加剧 L1 碎片)。**32B 全矩阵运行中(TP=2,chunk 128-1024 × L1 8/16)**。
